...
END COMPONENT;
  ...
  SIGNAL GPIO1_tri_i    : STD_LOGIC_VECTOR( 7 DOWNTO 0);  -- BTN and SW
  SIGNAL GPIO1_tri_o    : STD_LOGIC_VECTOR( 7 DOWNTO 0);  -- LED 
  SIGNAL GPIO2_tri_o    : STD_LOGIC_VECTOR(15 DOWNTO 0);  -- 7-seg display
...
----------------------------------------------------------------------------------
  ...
  --------------------------------------------------------------------------------
  -- MicroBlaze-V MCS
  microblaze_mcs_0_i : microblaze_mcs_0
  PORT MAP (
    Clk                 => CLK,
    Reset               => '0',        -- open(rozpojeno), null (uzemněno)
    UART_rxd            => UART_RXD,    -- pozor na směr in a out u komponenty
    UART_txd            => UART_TXD,
    GPIO1_tri_i         => GPIO1_tri_i,     -- vhodne propojit bokem pomocí signálů
