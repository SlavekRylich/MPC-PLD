...
#
# Script generated by Vivado on Fri Apr 24 09:41:10 +0200 2026
...
#                microblaze_mcs_0.sh [-rerun]
#                microblaze_mcs_0.sh [-reset_run]
#                microblaze_mcs_0.sh [-clean]
...
# script info
echo -e "microblaze_mcs_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/xrylic00/Documents/MPC-PLD/labs/pc10-lab/PC_10_template/PC_10_template/PC_10_template.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
...
Usage: microblaze_mcs_0.sh [-rerun]\n\
Usage: microblaze_mcs_0.sh [-reset_run]\n\
Usage: microblaze_mcs_0.sh [-clean]\n\
