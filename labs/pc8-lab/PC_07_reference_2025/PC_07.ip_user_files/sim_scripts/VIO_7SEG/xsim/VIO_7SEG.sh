...
#
# Script generated by Vivado on Fri Apr 10 11:32:09 +0200 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : VIO_7SEG.sh
...
#
# Usage        : VIO_7SEG.sh
#                VIO_7SEG.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                VIO_7SEG.sh [-rerun]
#                VIO_7SEG.sh [-reset_run]
#                VIO_7SEG.sh [-clean]
#                VIO_7SEG.sh [-reset_log]
#                VIO_7SEG.sh [-help]
#
...
export RDI_DATADIR="C:/Appz/AMDDesignTools/2025.2/Vivado/data"
...
# script info
echo -e "VIO_7SEG.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./VIO_7SEG.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot VIO_7SEG xil_defaultlib.VIO_7SEG xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim VIO_7SEG -key {Behavioral:sim_1:Functional:VIO_7SEG} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Appz/AMDDesignTools/2025.2/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb VIO_7SEG.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./VIO_7SEG.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: VIO_7SEG.sh [-help]\n\
Usage: VIO_7SEG.sh [-step]\n\
Usage: VIO_7SEG.sh [-lib_map_path]\n\
Usage: VIO_7SEG.sh [-rerun]\n\
Usage: VIO_7SEG.sh [-reset_run]\n\
Usage: VIO_7SEG.sh [-clean]\n\
Usage: VIO_7SEG.sh [-reset_log]\n\
Usage: VIO_7SEG.sh [-keep_index]\n\
Usage: VIO_7SEG.sh [-noclean_files]\n\n\
