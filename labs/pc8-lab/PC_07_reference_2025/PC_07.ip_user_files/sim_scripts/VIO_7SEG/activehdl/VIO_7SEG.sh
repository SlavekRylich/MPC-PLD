...
#                script (type 'VIO_7SEG.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/xrylic00/Documents/MPC-PLD/labs/pc8-lab/PC_07_reference_2025/PC_07.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
