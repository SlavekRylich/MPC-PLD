...
#                script (type 'FIR_50k.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/xrylic00/Documents/MPC-PLD/labs/pc9-lab/PC_09_template_2025/PC_09.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
