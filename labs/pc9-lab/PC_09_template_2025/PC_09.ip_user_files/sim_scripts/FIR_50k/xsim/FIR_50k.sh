...
#
# Script generated by Vivado on Fri Apr 17 10:05:36 +0200 2026
...
#
# Usage        : FIR_50k.sh
#                FIR_50k.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                FIR_50k.sh [-rerun]
#                FIR_50k.sh [-reset_run]
#                FIR_50k.sh [-clean]
#                FIR_50k.sh [-reset_log]
#                FIR_50k.sh [-help]
#
...
# script info
echo -e "FIR_50k.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./FIR_50k.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_15 -L axi_utils_v2_0_11 -L xbip_pipe_v3_0_11 -L fir_compiler_v7_2_26 -L secureip -L xpm --snapshot FIR_50k xil_defaultlib.FIR_50k -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb FIR_50k.wdb xsim.dir libdpi.so)
...
Usage: FIR_50k.sh [-step]\n\
Usage: FIR_50k.sh [-lib_map_path]\n\
Usage: FIR_50k.sh [-rerun]\n\
Usage: FIR_50k.sh [-reset_run]\n\
Usage: FIR_50k.sh [-clean]\n\
Usage: FIR_50k.sh [-reset_log]\n\
Usage: FIR_50k.sh [-keep_index]\n\
